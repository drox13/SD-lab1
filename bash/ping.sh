curl -I http://172.17.0.2:8000/status | cat - /home/lab1/server1.txt > temp && mv temp /home/lab1/server1.txt
curl -I http://172.17.0.3:8000/status | cat - /home/lab1/server2.txt > temp && mv temp /home/lab1/server2.txt
