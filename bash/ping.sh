...
current_date=$(date)
last_server1_ping=$(curl -s -o /dev/null -w '%{http_code}' 172.17.0.2:8000)
last_server2_ping=$(curl -s -o /dev/null -w '%{http_code}' 172.17.0.3:8000)
history_server1_ping=$(curl -s -o /dev/null -w '%{http_code}' 172.17.0.2:8000)
history_server2_ping=$(curl -s -o /dev/null -w '%{http_code}' 172.17.0.3:8000)
